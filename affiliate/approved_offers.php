...
$affiliateName = $_SESSION['user_name'] ?? 'Publisher';
...
<head>
    ...
    <title>My Approved Offers | Affiliate Portal</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block"><a href="approved_offers.php" class="nav-link active">Approved Offers</a></li>
        </ul>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="approved_offers.php" class="nav-link active">
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6"><h1 class="m-0 font-weight-bold">My Approved Campaign Offers</h1></div>
                    <div class="col-sm-6">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card card-custom p-4">
                    <h4 class="font-weight-bold text-primary mb-3"><i class="fas fa-check-circle mr-2"></i>Approved Campaigns Catalog</h4>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle" id="approvedOffersTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong class="text-success">$<?php echo number_format($o['payout'], 2); ?> <?php echo $o['currency']; ?></strong></td>
                                    <td><strong><?php echo number_format($o['clicks']); ?></strong></td>
                                    <td><strong class="text-success"><?php echo number_format($o['conversions']); ?></strong></td>
                                    <td>
                                        <a href="offer_view.php?id=<?php echo $o['offer_id']; ?>" class="btn btn-sm btn-primary font-weight-bold">
                                            <i class="fas fa-eye mr-1"></i> View Links
                                        </a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
...
$(document).ready(function() {
    $('#approvedOffersTable').DataTable({ pageLength: 10, responsive: true });
});
</script>
</body>
</html>
