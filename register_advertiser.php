...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = register_user('advertiser', $data);
...
<?php if ($success): ?>
    <p style="color:green;">
        Registration successful. Your advertiser account is pending approval.
    </p>
<?php else: ?>
<form method="post" autocomplete="off">
    ...
    <button type="submit">Create Advertiser Account</button>
